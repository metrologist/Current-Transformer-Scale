...
class BURDEN(object):
    ...
    def __init__(self, excelfile, datasheet):
        ...
        self.mydata = self.data_store.getdata_block(self.datasheet, [4, 6, 10, 12])
...
if __name__ == "__main__":
    ...
    stuff = myburden.mydata
    print(myburden.tuple_to_complex(stuff[0]))
    print(myburden.get_test_result(4))
    print('starting run')
